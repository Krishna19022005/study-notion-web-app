        ...
        <div className='mb-20'>
            ...
            <section className='bg-richblack-700 pt-8'>
                <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                    ...
                    <div className="h-[200px] lg:h-[250px]"></div>
            ...
            <section className='border-b border-richblack-700'>
                <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between text-richblack-500'>
                    <div className='flex border-b border-richblack-700 flex-col items-center lg:flex-row justify-between'>
                        <div className='my-24 flex lg:w-[50%] flex-col '>
